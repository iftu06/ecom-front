      ...
      <div className="h-100 h-custom">
        <div className="container h-100">
          <div className="row d-flex justify-content-center align-items-center h-100">
            <div className="card cart-container cart-container-2" style={{ borderRadius: '15px' }}>
              <div className="card-body p-0">
                <div className="row g-0">
                  <div className="col-lg-12">
                    <div className="p-2">
                      <div className="d-flex justify-content-between align-items-center mb-3 pt-3">
                        <h3 className="fw-bold mb-0 text-black"><i>Shopping Cart</i></h3>
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-md-3 col-lg-3 col-xl-5">
                          <h6 className="product-cart-name">Shirt Cotton T-shirt</h6>
                          <h6 className="mb-0 product-cart-amount">44.00 BDT</h6>
                        </div>
                        ...
                        <div className="col-md-1 col-lg-1 col-xl-1 text-end">
                          <a href="#!" className="text-muted product-remove-icon"><i className="fas fa-times"></i></a>
                        </div>
                      </div>
                      ...
                      <div className="cart-footer">
                        ...
                        <div className="row">
                          <div className="col-md-6 pe-0">
                            <button type="button" className="btn btn-md btn-outline-danger cart-btn-cancel">Danger</button>
                          </div>
                          <div className="col-md-6 ps-0">
                            <button className="btn btn-outline-primary cart-btn-checkout">Check Out</button>
                          </div>
                        </div>
                      </div>
                    </div>
